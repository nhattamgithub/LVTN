...
const RejectedKYCs = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios.get(`${urlAPI}/get/rejected`).then((response) => {
  ...
  return (
    <FusePageCarded
      header={<KYCsHeader handleSearchText={handleSearchText} filterdType={"Rejected KYCs"}/>}
      content={<KYCTable kycs={filteredData} searchText={searchText} filterdType={"Rejected KYCs"}/>}
